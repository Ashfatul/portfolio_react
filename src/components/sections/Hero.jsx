            ...
            <div className="hero__code-window">
              ...
              <pre className="hero__code-body">
                <code>
                  ...
                  &nbsp;&nbsp;<span className="code-key">role</span>: <span className="code-str">&apos;Frontend Developer&apos;</span>,<br />
                  ...
                  &nbsp;&nbsp;<span className="code-key">passion</span>: <span className="code-str">&apos;Building Wow UI/UX Interfaces&apos;</span>,<br />
