            ...
            <div className="row mt-5 align-items-center">
                ...
                <div className="col-lg-5 offset-lg-1">
                    <form onSubmit={sendEmail} className="contact_form">
                        ...
                        <input type="text" required name="name" id="contact_name" value={name} onChange={(e) => setName(e.target.value)} />

                        <label htmlFor="contact_email">Your Email</label>
                        <input type="email" required name="email" id="contact_email" value={email} onChange={(e) => setEmail(e.target.value)} />

                        <label htmlFor="contact_message">Your Message</label>
                        <textarea name="message" required id="contact_message" cols="30" rows="10" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
